...
* `zold` Nama pengguna yang masuk ke konsol
* `ubuntu-os` nama komputer atau server jarak jauh
* `~` direktori home dan itu akan, dan itu akan berubah sesuai dengan direktori tempat dia berada
